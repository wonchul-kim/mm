...
from mm.segmentation.src.models import COSNet
...
def main():
    # set config =======================================================================================================
    args = parse_args()
    add_params_to_args(args, ROOT / 'params/cosnet_r101_tenneco_outer.yaml')

    config_file = ROOT / '../../configs/models/cosnet/uper_cosnet.py'
