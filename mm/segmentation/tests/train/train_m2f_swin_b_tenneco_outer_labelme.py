...
def main():
    # set config =======================================================================================================
    args = parse_args()
    add_params_to_args(args, ROOT / 'params/m2f_swin_b_tenneco_outer_labelme.yaml')

    config_file = ROOT / '../../configs/models/mask2former/mask2former_swin-b-in22k-384x384-pre_8xb2.py'
