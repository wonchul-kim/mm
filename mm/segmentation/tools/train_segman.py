...
def parse_args():
    ...
    parser.add_argument('--config', default='/HDD/_projects/github/mm/mm/segmentation/configs/models/segman/segman_b_ade.py')
    parser.add_argument('--work-dir', default='/HDD/etc/outputs/segman')
    parser.add_argument(
        '--resume',
        action='store_true',
        default=False,
