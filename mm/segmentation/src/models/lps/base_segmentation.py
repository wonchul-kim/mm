...
from mm.segmentation.src.models.lps.thirdparty.utils.loss import FocalLoss
from mm.segmentation.src.models.lps.thirdparty import network
from mm.segmentation.src.models.lps.thirdparty import utils
from .lps_segmentation import lps_resnet_segmentation, lps_resnet_segmentation_unpool
...
class BaseSegmentation(pl.LightningModule):
    def __init__(self, loss_type='focal',
        ...
        self.val_segmetrics = SegmentationMetrics(task='binary', num_classes=self.num_classes)

        self.test_acc = Accuracy(task='binary', num_classes=self.num_classes)
        self.test_segmetrics = SegmentationMetrics(task='binary', num_classes=self.num_classes)
...
DDAC_MODEL_MAP = {
    ...
    'deeplabv3_resnet_lps': lps_resnet_segmentation,
    'deeplabv3plus_resnet_lps': lps_resnet_segmentation,
    'deeplabv3plus_resnet_lps_unpool': lps_resnet_segmentation_unpool,
}
