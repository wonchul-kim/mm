...
def deeplabv3_resnet18(pretrained=False, progress=True,
    ...
    """
    return _load_model('deeplabv3', 'resnet18', pretrained, progress, num_classes, **kwargs)
...
def deeplabv3plus_resnet18(pretrained=False, progress=True,
                       num_classes=21, **kwargs):
    """Constructs a DeepLabV3 model with a ResNet-50 backbone.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _load_model('deeplabv3plus', 'resnet18', pretrained, progress, num_classes, **kwargs)
