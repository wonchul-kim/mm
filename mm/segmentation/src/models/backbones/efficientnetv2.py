...
#     def __init__(self, arch='b2', out_indices=(1, 2, 3, 4), 
#                  norm_cfg=dict(type='SyncBN', requires_grad=True), 
#                  norm_eval=False, frozen_stages=0, with_cp=False,
...
#         #     with_cp=with_cp, 
#         #     init_cfg=dict(type='Pretrained', checkpoint=pretrained) if pretrained else None
#         # ))
...
from mmseg.registry import MODELS
from mmengine.model import BaseModule
from mmpretrain.models.utils import InvertedResidual as MBConv
from mmpretrain.models.backbones.base_backbone import BaseBackbone
from mmpretrain.models.backbones.efficientnet import EdgeResidual as FusedMBConv
...
class EfficientNetV2(BaseModule):
    ...
    def forward(self, x: Tensor) -> Tuple[Tensor]:
        ...
        return tuple(outs) # [(bs, 32, 384, 560), (bs, 16, 384, 560), (bs, 32, 192, 280), (bs, 48, 96, 140)]
