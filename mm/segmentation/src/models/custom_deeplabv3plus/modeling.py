from mm.segmentation.src.models.custom_deeplabv3plus.utils import IntermediateLayerGetter
from mm.segmentation.src.models.custom_deeplabv3plus._deeplab import DeepLabHead, DeepLabHeadV3Plus, DeepLabV3
from mm.segmentation.src.models.custom_deeplabv3plus.backbone import (
    resnet,
    mobilenetv2,
    hrnetv2,
    xception
...
class CustomDeeplabv3plus(BaseModule):
    def __init__(self, num_classes: int):
        super().__init__()
            
        self.model = deeplabv3plus_resnet18(num_classes=num_classes, output_stride=8)
