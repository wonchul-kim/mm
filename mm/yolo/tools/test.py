...
def parse_args():
    ...
    # parser.add_argument('--config', default='/HDD/_projects/github/mm/mm/yolo/configs/models/yolov8/yolov8_m_mask-refine_syncbn_fast_8xb16_coco.py')
    parser.add_argument('--config', default='/DeepLearning/etc/_athena_tests/benchmark/tenneco/outer_repeat_unit/detection/mmseg_yolov8_m_epochs500/yolov8_m_mask-refine_syncbn_fast_8xb16_coco.py')
    parser.add_argument('--checkpoint', default='/DeepLearning/etc/_athena_tests/benchmark/tenneco/outer_repeat_unit/detection/mmseg_yolov8_m_epochs500/best_coco_MARK_precision_epoch_490.pth')
    parser.add_argument('--work-dir', default='/HDD/etc/outputs/mmyolo/')
    parser.add_argument(
        '--out',
        type=str,
